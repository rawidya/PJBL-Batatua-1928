...
<head>
    ...
    <title>Contact - Batatua 1928</title>
</head>
   ...
   <header>
    ...
    <section id="home" class="relative h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('Assets/Hero Image (2).png');">
        ...
        <div class="relative z-10 text-center text-white px-4">
            <h1 class="text-4xl md:text-6xl font-bold mb-4 text-black">CONTACT US</h1>
            <a href="https://www.instagram.com/kedaibatatua.id/" target="_blank" class="mt-6 inline-block px-6 py-3 bg-yellow-700 text-black font-semibold rounded-2xl hover:bg-yellow-600 transition-colors duration-300">Instagram</a>
            <a href="https://wa.me/" target="_blank" class="mt-6 inline-block px-6 py-3 bg-yellow-700 text-black font-semibold rounded-2xl hover:bg-yellow-600 transition-colors duration-300">Whatsapp</a>
        </div>
    </section>
    ...
    <section id="about" class="py-20 bg-[#fff9e6]">
        <div class="flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-6 p-6">
            <img src="Assets/Tempat 2.jpg" alt="logo batatua" class="w-80 md:w-96 rounded-lg mb-6 md:mb-0">
